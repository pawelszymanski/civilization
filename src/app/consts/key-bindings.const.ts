...
export const DEFAULT_KEY_BINDINGS: KeyBindings = {
  ...
  [UserActionId.TOGGLE_TILE_YIELD]: {keyCode: KeyCodeId.KeyY, modifiers: KEY_MODIFIER_NONE},
  [UserActionId.TOGGLE_TILE_TEXT]: {keyCode: KeyCodeId.KeyI, modifiers: KEY_MODIFIER_NONE},
